...
export default () => {
  ...
  const addSector = () => {
    ...
    handleChange("sectorsList", [...userInput.sectorsList, { title: name }]);
  };
      ...
      <form className="about-form">
          ...
          <MDBCol md="12" style={{ margin: "auto" }}>
            {userInput.sectorsList.map((sector, i) => (
              <div className="custom-control custom-radio custom-control-inline">
                ...
                />
                <label className="custom-control-label" htmlFor={`radio${i}`}>
                  {sector.title}
                </label>
              </div>
            ))}
        ...
        <MDBRow>
          <MDBCol md="12">
            ...
            />
            {userInput.sectorsList[tab] && userInput.sectorsList[tab].image ? (
              <Img
                className="img-thumb "
