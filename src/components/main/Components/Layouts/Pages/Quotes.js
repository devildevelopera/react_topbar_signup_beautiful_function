			...
			<div className="quotes-block">
				<MDBContainer>
					...
					<div className="quotes-block-content">
						<MDBRow>
							{" "}
							<p className="quotes-block-content-p">
								In an idea world this website wouldn't exist,a
								client would acknowledge the importance of
						...
						<MDBRow style={{ marginTop: "5%" }}>
							<MDBCol
								md="4"
								className="text-md-center mt-xl-5 mb-5"
							>
								<div className="quotes-steps">
									...
									<p>
										the big oxmax advised her not to do so.
									</p>
								</div>
							</MDBCol>
							<MDBCol
						...
						<A href="/login">
							<MDBBtn color="danger">Get Started </MDBBtn>
						</A>
					</div>
				</MDBContainer>
			</div>
